### this is a very lightly modified version of the original vrme_lib file
...
def load_data(path, embedding_path = 'data/original/df_embeddings.csv'):
    embedding_path = embedding_path
    submission_path = path+'df_submission_rating.csv'
...
def mean_predictions(dummy, y_pred):
    """
    Helpful for error diagnosing. Returns the mean of the predicted values
    Args:
