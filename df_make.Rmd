...
df2018 = read.csv("arxiv_results_2018.csv", header = T)
...
- Jan. 9, 2018 : rebuttal period
- Jan. 29, 2018 : decision
...
```{r}
df_test = read.csv("data/reviewer_all_2017_found_2018/df_submission_rating.csv", header = T)
```
